...
export function validatePayload(body) {
  ...
  if (body.gitHubUser !== undefined && body.gitHubUser !== null) {
  ...
  if (body.repoName !== undefined && body.repoName !== null) {
  ...
  if (body.featureSpec !== undefined && body.featureSpec !== null) {
    if (typeof body.featureSpec !== 'string') {
      errors.push({ field: 'featureSpec', message: 'featureSpec must be a string if provided' });
    }
  }

  // stories — optional array of { title, content }
  if (body.stories !== undefined && body.stories !== null) {
  ...
  const data = {
    ...
    stages: body.stages,
    featureSpec: body.featureSpec ?? null,
