...
export function computeInsights(runs) {
  ...
  if (totalRuns === 0) {
    return {
      ...
      last7Days: 0, last30Days: 0, topRepoByRunCount: null, avgFeedbackRating: null,
    };
  }
